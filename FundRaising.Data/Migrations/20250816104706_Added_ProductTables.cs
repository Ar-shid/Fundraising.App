...
{
    /// <inheritdoc />
    public partial class Added_ProductTables : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsSinglePurchase = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CompaignProducts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CompaignProducts_Compaigns_CompaignId",
                        column: x => x.CompaignId,
                        principalTable: "Compaigns",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CompaignProducts_Products_ProductId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CompaignProducts_CompaignId",
                table: "CompaignProducts",
                column: "CompaignId");

            migrationBuilder.CreateIndex(
                name: "IX_CompaignProducts_ProductId",
                table: "CompaignProducts",
                column: "ProductId");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_CompaignGroups_Groups_GroupId",
                table: "CompaignGroups",
                column: "GroupId",
